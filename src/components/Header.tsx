  ...
  return (
    <header className="h-screen pt-28 overflow-hidden">
      <div className="container text-center h-full relative">
        <h3 className="font-medium text-[var(--color-primary)] text-2xl">Welcome -- My Portfolio Page.</h3>
        <h1 className="font-semibold text-[var(--color-primary)] text-5xl">I'm Seni</h1>
        <h3 className="font-medium text-[var(--color-primary)] text-2xl">Javascript Developer</h3>
